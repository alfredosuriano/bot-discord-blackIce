        ...
        try {
            ...
            if ( embed === 'audition') {
                const embed1 = new Discord.EmbedBuilder()
                    ...
                    .setDescription(`
Questa categoria è privata e riservata esclusivamente ai membri del Team Ranked. 
...
In bocca al lupo! <:leaf_black_ice:1276318911545081916>`);
            ...
            if ( embed === 'maintenance') {                
                const embed = new Discord.EmbedBuilder()
                    ...
                    .setDescription(
`Questo canale è in fase di sviluppo o manutenzione, ma ci siamo quasi!
...
Stay tuned <:leaf_black_ice:1276318911545081916>`);
            ...
            if ( embed === 'rank') {
                const embed = new Discord.EmbedBuilder()
                    ...
                    .setDescription(
`Sei in streak-lose e sei sceso di grado? Skill issue bro :smirk_cat:
